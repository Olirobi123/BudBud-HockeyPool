    ...
    <CardHeader className="pb-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm text-muted-foreground">{formatDate(echange.date)}</span>
        </div>
    ...
    <CardContent className="pt-0">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
        <div className="text-center">
          <h3 className="font-semibold text-foreground mb-2">{echange.equipe_source_nom}</h3>
        </div>
        <div className="text-center">
          <ArrowLeftRight className="w-6 h-6 text-muted-foreground mx-auto" />
        </div>
        <div className="text-center">
          <h3 className="font-semibold text-foreground mb-2">{echange.equipe_destination_nom}</h3>
        </div>
      </div>
