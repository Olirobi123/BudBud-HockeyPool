                  ...
                  <CardContent>
                    {player.featuredStats ? (
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1">
                          <p className="text-sm text-gray-500">Buts PP</p>
                          <p className="font-medium">{player.featuredStats.regularSeason.subSeason.powerPlayGoals}</p>
                        </div>
                      </div>
                    ) : (
                        ...
                        <>
                          ...
                          <Table>
                            ...
                            <TableBody>
                              {player.seasonTotals
                                .sort((a, b) => {
                                  // D'abord trier par saison
                                  const seasonDiff = b.season - a.season;
                                  if (seasonDiff !== 0) return seasonDiff;
                                  // Pour la même saison, playoffs après saison régulière
